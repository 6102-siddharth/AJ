...
create table Student_info (Roll_No int, F_Name varchar(50), L_name varchar(50),City char(50),Phone_no varchar(10) ) ;

insert into Student_info values (1,"Siddharth","Vadgaonkar","Pune","7218140400") ;

select * from Student_info;


-- create database arbor2;
-- create table employe_info(id int, Name char(50), Phone char(10));
-- insert into employe_info values(1,"sarthpatil","7896541230");

-- drop database arbor2;
...
select * from employees where is_manager = true or salary >=80000;
...
select  * from employees where hire_date between '2023-01-01' and '2023-12-31' or department= 'HR' ;  
