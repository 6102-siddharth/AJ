...
alter table flights 																							-- To delete the column  
drop AvailableSeats;																							-- Alte rtable Table_name drop Column_name
...
alter table flights 
add DepartureTerminal varchar(50) default 'T1';
...
alter table flights
add column gatenumber varchar(50) default 'A1';
