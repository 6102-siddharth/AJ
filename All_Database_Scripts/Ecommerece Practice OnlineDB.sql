...
select customer_name, max(total_amount) as Highest_amount from customers c
join orders o
...
-- 21.	Display customer name with their order IDs.
select order_id,customer_name
from Orders as o join customers as c
on c.customer_id=o.customer_id;  

-- 22.	Show order details with customer name and order date.
select o.order_id, customer_name ,order_date
from orders as o join customers as c
on o.customer_id=c.customer_id;

-- 23.	Display product name with quantity sold.
select product_name ,sum(quantity)
from products as p join order_items as oi
on P.product_id=oi.product_id
group by product_name;

-- 24.	List customer name, product name, and quantity.
...
-- 26.	Find customers who never placed any order.


-- 27.	Display products that were never ordered.


-- 28.	Show orders with total number of items in each order.


-- 29.	Display customer name and total amount spent.
