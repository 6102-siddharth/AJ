...
select * from cars;
select brand,year, count(year) from cars group by brand,year ;
-- 1.	Retrieve the details of cars with prices greater than the average price.
select * from cars where price > (select avg(price) from cars);

-- select brand,price, avg(price) from 
-- cars group by brand, price															-- when i apply greater than = then only shows results
...
-- select brand, price, 
-- avg(price) as avg_price from cars 
-- where fueltype= 'gasoline' 
-- group by brand, price																-- when i apply greater than = then only shows results
--  having price >= avg_price;    

-- select fueltype where fueltype= 'gasoline' , avg(price) from cars group by brand ; 
